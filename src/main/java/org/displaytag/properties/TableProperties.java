...
public final class TableProperties implements Cloneable
{
    ...
    private TableProperties(Locale myLocale) throws TablePropertiesLoadException
    {
        ...
        //XXX don't load them here - use the locale provider
     ...
     * @return String
     */
    public String getPagingInvalidPage(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_INVALIDPAGE, context);
    }
     ...
     * @return String
     */
    public String getPagingItemName(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_ITEM_NAME, context);
    }
     ...
     * @return String
     */
    public String getPagingItemsName(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_ITEMS_NAME, context);
    }
     ...
     * @return String
     */
    public String getPagingFoundNoItems(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_NOITEMS, context);
    }
     ...
     * @return String
     */
    public String getPagingFoundOneItem(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_FOUND_ONEITEM, context);
    }
     ...
     * @return String
     */
    public String getPagingFoundAllItems(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_FOUND_ALLITEMS, context);
    }
     ...
     * @return String
     */
    public String getPagingFoundSomeItems(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_FOUND_SOMEITEMS, context);
    }
     ...
     * @return String
     */
    public String getPagingBannerOnePage(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_BANNER_ONEPAGE, context);
    }
     ...
     * @return String
     */
    public String getPagingBannerFirst(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_BANNER_FIRST, context);
    }
     ...
     * @return String
     */
    public String getPagingBannerLast(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_BANNER_LAST, context);
    }
     ...
     * @return String
     */
    public String getPagingBannerFull(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_BANNER_FULL, context);
    }
     ...
     * @return String
     */
    public String getPagingPageLink(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_PAGE_LINK, context);
    }
     ...
     * @return String
     */
    public String getPagingPageSelected(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_PAGE_SELECTED, context);
    }
     ...
     * @return String
     */
    public String getPagingPageSeparator(PageContext context)
    {
        return getProperty(PROPERTY_STRING_PAGING_PAGE_SPARATOR, context);
    }
    ...
    //XXX added to achieve a behaviour similar to the resolution of table title and column titles
    /**
     * Use the active locale provider to fetch the translation. Only use the fallback property if no entry for the current locale is found.
     * @param key property name
     * @param context the page context of the resolution
     * @return the resolved language property or its fallback or <code>null</code> if none is found
     */
    private String getProperty(String key, PageContext context) {
       // use the default key value to avoid error messages on missing entries - in that case a null is returned here
       String text = geResourceProvider().getResource(null, key, null, context);
       return text != null ? text : getProperty(key);
    }
