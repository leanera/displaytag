 ...
 * @version $Revision: 1140 $ ($Author: fgiust $)
 */
public class I18nSpringAdapter implements LocaleResolver, I18nResourceProvider
{
    ...
    {
        MessageSource messageSource = RequestContextUtils.findWebApplicationContext((HttpServletRequest) pageContext.getRequest(), pageContext.getServletContext());
