    ...
    protected void setupViewableData()
    {
        ...
        if (this.paginatedList == null && this.pagesize > 0)
        {
            this.listHelper = new SmartListHelper(fullList, (this.partialList) ? ((Integer) size).intValue() : fullList
                .size(), this.pagesize, this.properties, this.partialList, this.pageContext);
        ...
        {
            this.listHelper = new PaginatedListSmartListHelper(this.paginatedList, this.properties, this.pageContext);
        }
